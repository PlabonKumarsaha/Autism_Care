...
<div class="fixed-top">
        ...
        <nav class="navbar navbar-light" style="background-color: #036889">
            <div class="container">
                ...
                <a href="#" class="navbar-brand"><button type="button" class="btn btn-outline-danger">Make An Appointment</button></a>
            </div>
        </nav>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-center" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item active">
                            <a href="" class="nav-link"> <b>Therapist</b> <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
                            <a href="" class="nav-link"> <b>Blogs</b> <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
...
<div class="card mb-3" style="max-width:950px;">
  ...
  <div class="row no-gutters">
    <div class="col-md-4">
      <img class="profile-image" src="images/ashiq.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">DR. H.N. ASHIQUR RUHULLAH</h5>
...
<div class="card mb-3" style="max-width:950px;">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">DR. MD. TANVIR ANJHUM</h5>
        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card mb-3" style="max-width:950px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img class="profile-image" src="images/kumar.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">Dr. PLABION KUMAR SAHA</h5>
        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card mb-3" style="max-width:950px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img class="profile-image" src="images/kalpo.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">DR.KALPO KALLUL ROY</h5>
        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card mb-3" style="max-width:950px;">
  <div class="row no-gutters">
    <div class="col-md-4">
      <img class="profile-image" src="images/rahim.jpg" class="card-img" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">DR. NAFISA ISRAT</h5>
        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card mb-3" style="max-width:950px;">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title">DR. MD. RAHIM</h5>
        <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
        <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small> Just $100</p>
